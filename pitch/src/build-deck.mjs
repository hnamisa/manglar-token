...
async function build() {
  ...
  // Slide 1: cover
  {
    ...
    text(slide, "Hiro Namisato Maetahara · John Nunez Perez", { x: 64, y: 632, w: 480, h: 24, size: 15, color: "#BED6CF", name: "cover-team" });
  }
  ...
  // Slide 8: roadmap
  {
    ...
    text(slide, "Hiro Namisato Maetahara · John Nunez Perez", { x: 362, y: 644, w: 556, h: 24, size: 16, color: C.gold, bold: true, align: "center", name: "roadmap-team" });
  }
